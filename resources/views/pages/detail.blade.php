          ...
          <div class="row">
            <div class="col-12 col-lg-8">
              <ul class="list-unstyled">
                ...
                <li class="media">
                  <img
                    src="/images/riview2.png"
                    alt=""
                    class="mr-3 rounded-circle"
                  />
                  <div class="media-body">
                    <h5 class="mt-2 mb-1">chealsea islan</h5>
                ...
                <li class="media">
                  <img
                    src="/images/riview3.png"
                    alt=""
                    class="mr-3 rounded-circle"
                  />
                  <div class="media-body">
                    <h5 class="mt-2 mb-1">ariel Noah</h5>
