...
@section('content')
    <div class="page-content page-auth">
        <div class="section-store-auth" data-aos="fade-up">
            <div class="container">
                <div class="row row-align-items-center row-login">
                    ...
                    <div class="col-lg-5">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="mt-3">
                            ...
                            <button type="submit" class="btn btn-success w-75 mt-4"
                                >Sign in To Your Account</button
                            >
                            <a href="{{ route('register') }}l" class="btn btn-signup w-75 mt-4"
                                >Sign up</a
                            >
                        </form>
                    </div>
